...
/** 
 * Class, in which contains simple blockchain from transactions and blocks. <br>
 *  
 * You can run it, experiment with changing of values. You can see how hash values of next block are changes when current block is changed. <br>  
 *  
